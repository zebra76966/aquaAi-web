...
export default function SchoolOfFishModel({ animationSpeed = 1 }) {
  const { scene, animations } = useGLTF("/models/school_of_fish.glb");
...
useGLTF.preload("/models/school_of_fish.glb");
